...
contract Subscriber {
    ...
    function Subscriber(address tokenAddress, address dispatchAddress, address bondageAddress) public {
    ...
    */
    function queryTest(address provider, string query) public returns(uint256 ) {
        ...
        uint256 id = dispatch.query(provider, query, specifier, endpoint_params);
        return id;
    }
